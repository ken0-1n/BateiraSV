...
def create_parser():
    ...
    def _create_curate_parser(subparsers):
        ...
        curate_parser.add_argument("--margin", help = "The margin for comparing SVs and SVs", type = int, default = 10)
        ...
        curate_parser.add_argument("--validate_sequence_length", help = "Length of sequences for validation (each from the breakpoint) (default: %(default)s)", type = int, default = 100)
